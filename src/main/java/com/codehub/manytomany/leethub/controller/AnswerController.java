...
public class AnswerController {
    ...
    @PutMapping("/{answerId}/add-question/{questionId}")
    public ResponseEntity<Answer> addQuestionToAnswer(
            @PathVariable Long answerId,
            @PathVariable Long questionId) {
        Answer updatedAnswer = answerService.addQuestionToAnswer(answerId, questionId);
